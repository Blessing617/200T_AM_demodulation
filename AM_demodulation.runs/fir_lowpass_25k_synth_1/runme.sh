...
HD_PWD='D:/Xilinx/Project/200t/AM_demodulation/AM_demodulation.runs/fir_lowpass_25k_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fir_lowpass_25k.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fir_lowpass_25k.tcl
