...
HD_PWD='D:/Xilinx/Project/200t/AM_demodulation/AM_demodulation.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AM_demodulation.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AM_demodulation.tcl -notrace
