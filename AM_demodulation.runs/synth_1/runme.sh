...
HD_PWD='D:/Xilinx/Project/200t/AM_demodulation/AM_demodulation.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AM_demodulation.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AM_demodulation.tcl
